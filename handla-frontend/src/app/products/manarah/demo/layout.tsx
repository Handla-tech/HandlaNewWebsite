...
/**
 * Server-component layout for the /products/manarah/demo/* route segment.
 ...
 * in search results.
 *
 * Applied to this segment and all nested demo routes (website, mobile, …):
 ...
 * demo pages do not carry a /products/manarah canonical.
 */
...
export default function ManarahDemoLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
