...
export default function ProjectsPage() {
  ...
  const rowActions: RowAction<Project>[] = [
    { label: 'Edit Project', icon: Pencil, onClick: (p) => setEditProject(p) },
    { label: 'Delete', icon: Trash2, danger: true, onClick: (p) => setDeleteProject(p), show: () => isAdmin },
  ];
          ...
          {pages > 1 && (
            <div className="flex items-center justify-between pt-2">
              <p className="text-sm text-white/30">
                {total} projects · page {page} of {pages}
              </p>
