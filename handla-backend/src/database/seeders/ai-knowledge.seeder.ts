...
const SEED_ENTRIES: KnowledgeSeed[] = [
  // ─── COMPANY ────────────────────────────────────────────────────────────────
  {
    ...
    tags: 'handla, about, who are you, company, what do you do, software house, overview, services',
    priority: 100,
  },
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'services, products, offerings, capabilities, what can you build, list, madar, matjary, manarah',
    priority: 95,
  },
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'mission, values, approach, why handla, quality, transparency, partnership',
    priority: 60,
  },
  {
    title: 'What languages does Handla work in?',
    content:
      'Handla works in both Arabic and English. Our website, products (Madar, Matjary, Manarah) and the systems we build are bilingual (Arabic / English), and our team can communicate with you in either language.',
    category: KnowledgeCategory.COMPANY,
    tags: 'language, arabic, english, bilingual, عربي, انجليزي, ثنائي اللغة',
    priority: 50,
  },
  ...
  // ─── SERVICES (8 canonical) ───────────────────────────────────────────────────
  {
    ...
    tags: 'web development, website, web app, react, nextjs, next.js, frontend, backend, full-stack, landing page, dashboard',
    priority: 80,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'erp, crm, business system, invoicing, inventory, reporting, custom software, operations, finance, workflows',
    priority: 80,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'mobile, app, ios, android, react native, cross-platform, application, mobile app',
    priority: 80,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'cloud, hosting, infrastructure, devops, deployment, docker, ci/cd, aws, monitoring, servers, tls, domains',
    priority: 70,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'video, video editing, reels, montage, motion graphics, subtitles, social media video, ads, editing',
    priority: 60,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'podcast, podcast editing, audio, episodes, audio cleanup, clips, show, video podcast',
    priority: 55,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'design, branding, visual identity, logo, brand, guidelines, social media design, graphics',
    priority: 60,
  },
  {
    ...
    category: KnowledgeCategory.OTHER,
    tags: 'strategy, marketing, brand strategy, content, launch plan, growth, audience, channels, marketing plan',
    priority: 55,
  },
  ...
  // ─── PRODUCTS ───────────────────────────────────────────────────────────────
  {
    ...
    tags: 'madar, مدار, erp, agency, business management, clients, projects, invoices, contracts, quotations, expenses, reports, demo',
    priority: 85,
    product: 'madar',
  },
  {
    ...
    category: KnowledgeCategory.PRODUCT,
    tags: 'matjary, متجري, ecommerce, e-commerce, store, online store, pos, point of sale, inventory, retail, shop, commerce, demo',
    priority: 85,
    product: 'matjary',
  },
  {
    ...
    category: KnowledgeCategory.PRODUCT,
    tags: 'manarah, منارة, school, education, students, teachers, k-12, attendance, grades, report cards, parent app, student app, sms, school management, demo',
    priority: 85,
    product: 'manarah',
  },
  {
    ...
    category: KnowledgeCategory.PRODUCT,
    tags: 'demo, trial, try, test, preview, madar, matjary, manarah, see it, sample',
    priority: 70,
  },
  ...
  // ─── PROJECTS (genuine portfolio) ─────────────────────────────────────────────
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'tameer home, تعمير هوم, project, portfolio, web platform, case study, example, work, client',
    priority: 65,
  },
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'homy perfumes, هومي للعطور, project, portfolio, ecommerce, e-commerce, store, case study, example, work, client',
    priority: 65,
  },
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'emdad, إمداد, project, portfolio, visual identity, branding, logo, energy, case study, example, work',
    priority: 60,
  },
  {
    ...
    tags: 'portfolio, examples, past work, projects, references, clients, case studies, who have you worked with',
    priority: 60,
  },
  ...
  // ─── PROCESS ──────────────────────────────────────────────────────────────────
  {
    ...
    tags: 'process, how it works, steps, discover, design, build, launch, methodology, workflow, phases',
    priority: 75,
  },
  {
    ...
    category: KnowledgeCategory.PROCESS,
    tags: 'get started, start, begin, how do i, first step, consultation, kick off, onboarding, request',
    priority: 80,
  },
  ...
  // ─── SUPPORT ────────────────────────────────────────────────────────────────
  {
    ...
    category: KnowledgeCategory.FAQ,
    tags: 'support, maintenance, after launch, ongoing, help, sla, warranty, post-launch, updates',
    priority: 70,
  },
  ...
  // ─── PRICING (guidance only — NEVER final quotes) ─────────────────────────────
  {
    ...
    tags: 'price, pricing, cost, how much, quote, budget, fees, estimate, rates, expensive, cheap',
    priority: 85,
  },
  {
    ...
    category: KnowledgeCategory.PRICING,
    tags: 'timeline, how long, duration, delivery, time, deadline, when, schedule, eta',
    priority: 70,
  },
  ...
  // ─── CONTACT ──────────────────────────────────────────────────────────────────
  {
    ...
    category: KnowledgeCategory.FAQ,
    tags: 'contact, human, talk to someone, reach, get in touch, support, sales, phone, email, speak to a person, agent',
    priority: 90,
  },
  {
    ...
    category: KnowledgeCategory.COMPANY,
    tags: 'location, where, country, region, remote, area served, serve, based, worldwide',
    priority: 45,
  },
  ...
  // ─── POLICY / SAFETY ──────────────────────────────────────────────────────────
  {
    ...
    tags: 'policy, cannot, disclaimer, binding, quote, contract, discount, guarantee, confidential, limits',
    priority: 30,
  },
];
