#!/usr/bin/env node
/**
 * i18n-merge.mjs — deep-merge additional keys into the mobile en/ar JSON bundles.
 *
 * Usage: node scripts/i18n-merge.mjs <patchFile.json>
 * The patch file has shape { "en": {...}, "ar": {...} } and is deep-merged into
 * src/i18n/locales/{en,ar}.json (existing keys are NOT overwritten unless the
 * patch value is a string/number and the flag OVERWRITE=1 is set).
 */
